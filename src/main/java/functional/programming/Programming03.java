...
public class Programming03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(addTheListValues(List.of(12,4,5,3,2,99,44,3,6,66,77,88)));
        System.out.println(sumOfOddNumberInList(List.of(12,4,5,3,2,99,44,3,6,66,77,88)));
        System.out.println(sumOfCubesOfListElements(List.of(12,4,5,3,2,99,44,3,6,66,77,88)));
        System.out.println(sumOfEvenNumberInList(List.of(12,4,5,3,2,99,44,3,6,66,77,88)));
        System.out.println(squareNumbersFromlistAndSum(List.of(12,4,5,3,2,99,44,3,6,66,77,88)));
    ...
    private static Integer addListValuesFunctionalApproach(List<Integer> numbers){
        System.out.println("Sum of all numbers present in the list : ");
        return numbers.stream()
...
//Largest Number in the Array
    ...
    private static Integer sumOfCubesOfListElements(List<Integer> numbers){
        System.out.println("Print Sum of the Cubes of all the number present in the list : ");
        return numbers.stream()
    ...
    private static Integer sumOfOddNumberInList(List<Integer> numbers){
        System.out.println("Print Sum of the Odd number present in the list : ");
        return numbers.stream()
                .filter(x -> x%2 ==1)
                .reduce(0,(x,y) -> x+y);
    }
    ...
    private static Integer sumOfEvenNumberInList(List<Integer> numbers){
        System.out.println("Print Sum of Even number present in the list : ");
